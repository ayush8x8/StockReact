...
class CompanyComparisonChart2 extends Component {
                    ...
                    <div className="App">
                        ...
                        <div>
                            ...
                            <Form>
                                ...
                                <Form.Group className="mb-3">
                                    <Form.Control type="date" className="form-control" placeholder="Start Date 2" ref='startdate' />
                                </Form.Group>
                                <Form.Group className="mb-3">
                                    <Form.Control type="date" className="form-control" placeholder="End Date 2" ref='enddate' />
                                </Form.Group>
...
export default CompanyComparisonChart2;